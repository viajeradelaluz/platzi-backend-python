...
class GameController:
    ...
    def __init__(self, deck, view, high_card_winner) -> None:
        # Model
        self.players = []
        self.deck = deck
    ...
    def ready(self):
        ...
        while True:
            ...
            # Show the winner.
            self.view.show_winner(self.high_card_winner.find_winner(self.players))
...
game_controler = GameController(Deck(), View(), HighCardWinner())
