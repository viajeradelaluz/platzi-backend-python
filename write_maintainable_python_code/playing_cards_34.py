...
class GameController:
    ...
    def __init__(
        self, deck, player_view, broadcast_view, internet_view, high_card_winner
    ) -> None:
        # Model
        self.players = []
        self.deck = deck
        ...
        # View
        self.show_views = [player_view, broadcast_view, internet_view]
        self.prompt_view = player_view

        # Controller
        self.high_card_winner = high_card_winner
    ...
    def ready(self):
        ...
        while len(self.players) < 5:
            new_player = self.prompt_view.prompt_for_new_player()
        ...
        while True:
            ...
            # Show the winner.
            for view in self.show_views:
                view.show_winner(self.high_card_winner.find_winner(self.players))

            # Ask if the players want to play again.
            if not self.prompt_view.prompt_for_new_game():
                break
            self.rebuild_deck()
...
game_controler = GameController(
    Deck(), PlayerView(), BroadcastView(), InternetView(), HighCardWinner()
)
